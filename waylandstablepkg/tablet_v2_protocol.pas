...
type
  ...
  Pzwp_tablet_pad_dial_v2 = Pointer;
...
const
  ZWP_TABLET_V2_BUSTYPE_USB = 3; // USB
  ZWP_TABLET_V2_BUSTYPE_BLUETOOTH = 5; // Bluetooth
  ZWP_TABLET_V2_BUSTYPE_VIRTUAL = 6; // Virtual
  ZWP_TABLET_V2_BUSTYPE_SERIAL = 17; // Serial
  ZWP_TABLET_V2_BUSTYPE_I2C = 24; // I2C
...
type
  ...
  Tzwp_tablet_v2_listener = record
    ...
    bustype : procedure(data: Pointer; AZwpTabletV2: Pzwp_tablet_v2; ABustype: DWord); cdecl;
  end;
...
type
  ...
  Tzwp_tablet_pad_group_v2_listener = record
    ...
    dial : procedure(data: Pointer; AZwpTabletPadGroupV2: Pzwp_tablet_pad_group_v2; ADial: Pzwp_tablet_pad_dial_v2); cdecl;
  end;
...
type
  ...
  Pzwp_tablet_pad_dial_v2_listener = ^Tzwp_tablet_pad_dial_v2_listener;
  Tzwp_tablet_pad_dial_v2_listener = record
    delta : procedure(data: Pointer; AZwpTabletPadDialV2: Pzwp_tablet_pad_dial_v2; AValue120: LongInt); cdecl;
    frame : procedure(data: Pointer; AZwpTabletPadDialV2: Pzwp_tablet_pad_dial_v2; ATime: DWord); cdecl;
  end;
  ...
  ['IZwpTabletV2Listener']
    ...
    procedure zwp_tablet_v2_bustype(AZwpTabletV2: TZwpTabletV2; ABustype: DWord);
  end;
  ...
  ['IZwpTabletPadGroupV2Listener']
    ...
    procedure zwp_tablet_pad_group_v2_dial(AZwpTabletPadGroupV2: TZwpTabletPadGroupV2; ADial: TZwpTabletPadDialV2);
  end;
  ...
  IZwpTabletPadDialV2Listener = interface
  ['IZwpTabletPadDialV2Listener']
    procedure zwp_tablet_pad_dial_v2_delta(AZwpTabletPadDialV2: TZwpTabletPadDialV2; AValue120: LongInt);
    procedure zwp_tablet_pad_dial_v2_frame(AZwpTabletPadDialV2: TZwpTabletPadDialV2; ATime: DWord);
  end;
  ...
  TZwpTabletPadDialV2 = class(TWLProxyObject)
  private
    const _SET_FEEDBACK = 0;
    const _DESTROY = 1;
  public
    procedure SetFeedback(ADescription: String; ASerial: DWord);
    destructor Destroy; override;
    function AddListener(AIntf: IZwpTabletPadDialV2Listener): LongInt;
  end;
...
var
  ...
  zwp_tablet_pad_dial_v2_interface: Twl_interface;
...
var
  ...
  vIntf_zwp_tablet_pad_dial_v2_Listener: Tzwp_tablet_pad_dial_v2_listener;
...
procedure TZwpTabletPadDialV2.SetFeedback(ADescription: String; ASerial: DWord);
begin
  wl_proxy_marshal(FProxy, _SET_FEEDBACK, PChar(ADescription), ASerial);
end;

destructor TZwpTabletPadDialV2.Destroy;
begin
  wl_proxy_marshal(FProxy, _DESTROY);
  inherited Destroy;
end;

function TZwpTabletPadDialV2.AddListener(AIntf: IZwpTabletPadDialV2Listener): LongInt;
begin
  FUserDataRec.ListenerUserData := Pointer(AIntf);
  Result := wl_proxy_add_listener(FProxy, @vIntf_zwp_tablet_pad_dial_v2_Listener, @FUserDataRec);
end;
...
procedure zwp_tablet_v2_bustype_Intf(AData: PWLUserData; Azwp_tablet_v2: Pzwp_tablet_v2; ABustype: DWord); cdecl;
var
  AIntf: IZwpTabletV2Listener;
begin
  if AData = nil then Exit;
  AIntf := IZwpTabletV2Listener(AData^.ListenerUserData);
  AIntf.zwp_tablet_v2_bustype(TZwpTabletV2(AData^.PascalObject), ABustype);
end;
...
procedure zwp_tablet_pad_group_v2_dial_Intf(AData: PWLUserData; Azwp_tablet_pad_group_v2: Pzwp_tablet_pad_group_v2; ADial: Pzwp_tablet_pad_dial_v2); cdecl;
var
  AIntf: IZwpTabletPadGroupV2Listener;
begin
  if AData = nil then Exit;
  AIntf := IZwpTabletPadGroupV2Listener(AData^.ListenerUserData);
  AIntf.zwp_tablet_pad_group_v2_dial(TZwpTabletPadGroupV2(AData^.PascalObject),  TZwpTabletPadDialV2.Create(ADial));
end;
...
procedure zwp_tablet_pad_dial_v2_delta_Intf(AData: PWLUserData; Azwp_tablet_pad_dial_v2: Pzwp_tablet_pad_dial_v2; AValue120: LongInt); cdecl;
var
  AIntf: IZwpTabletPadDialV2Listener;
begin
  if AData = nil then Exit;
  AIntf := IZwpTabletPadDialV2Listener(AData^.ListenerUserData);
  AIntf.zwp_tablet_pad_dial_v2_delta(TZwpTabletPadDialV2(AData^.PascalObject), AValue120);
end;

procedure zwp_tablet_pad_dial_v2_frame_Intf(AData: PWLUserData; Azwp_tablet_pad_dial_v2: Pzwp_tablet_pad_dial_v2; ATime: DWord); cdecl;
var
  AIntf: IZwpTabletPadDialV2Listener;
begin
  if AData = nil then Exit;
  AIntf := IZwpTabletPadDialV2Listener(AData^.ListenerUserData);
  AIntf.zwp_tablet_pad_dial_v2_frame(TZwpTabletPadDialV2(AData^.PascalObject), ATime);
end;
...
const
  ...
  zwp_tablet_v2_events: array[0..5] of Twl_message = (
  ...
  zwp_tablet_pad_group_v2_events: array[0..6] of Twl_message = (
  ...
  zwp_tablet_pad_dial_v2_requests: array[0..1] of Twl_message = (
    (name: 'set_feedback'; signature: 'su'; types: @pInterfaces[0]),
    (name: 'destroy'; signature: ''; types: @pInterfaces[0])
  );
  zwp_tablet_pad_dial_v2_events: array[0..1] of Twl_message = (
...
initialization
  ...
  Pointer(vIntf_zwp_tablet_v2_Listener.bustype) := @zwp_tablet_v2_bustype_Intf;
  ...
  Pointer(vIntf_zwp_tablet_pad_group_v2_Listener.dial) := @zwp_tablet_pad_group_v2_dial_Intf;
  ...
  Pointer(vIntf_zwp_tablet_pad_dial_v2_Listener.delta) := @zwp_tablet_pad_dial_v2_delta_Intf;
  Pointer(vIntf_zwp_tablet_pad_dial_v2_Listener.frame) := @zwp_tablet_pad_dial_v2_frame_Intf;


  zwp_tablet_manager_v2_interface.name := 'zwp_tablet_manager_v2';
  zwp_tablet_manager_v2_interface.version := 2;
  ...
  zwp_tablet_seat_v2_interface.version := 2;
  ...
  zwp_tablet_tool_v2_interface.version := 2;
  ...
  zwp_tablet_pad_strip_v2_interface.version := 2;
  ...
  zwp_tablet_pad_group_v2_interface.version := 2;
  ...
  zwp_tablet_pad_group_v2_interface.event_count := 7;
  ...
  zwp_tablet_pad_v2_interface.version := 2;
  ...
  zwp_tablet_pad_dial_v2_interface.name := 'zwp_tablet_pad_dial_v2';
  zwp_tablet_pad_dial_v2_interface.version := 2;
  zwp_tablet_pad_dial_v2_interface.method_count := 2;
  zwp_tablet_pad_dial_v2_interface.methods := @zwp_tablet_pad_dial_v2_requests;
  zwp_tablet_pad_dial_v2_interface.event_count := 2;
  zwp_tablet_pad_dial_v2_interface.events := @zwp_tablet_pad_dial_v2_events;
