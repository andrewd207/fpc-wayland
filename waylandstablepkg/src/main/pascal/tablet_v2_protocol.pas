...
type
  ...
  ['IWpTabletV2Listener']
    ...
    procedure wp_tablet_v2_bustype(AWpTabletV2: TWpTabletV2; ABustype: DWord); {since: 2}
  end;
  ...
  ['IWpTabletPadGroupV2Listener']
    ...
    procedure wp_tablet_pad_group_v2_dial(AWpTabletPadGroupV2: TWpTabletPadGroupV2; ADial: TWpTabletPadDialV2); {since: 2}
  end;
