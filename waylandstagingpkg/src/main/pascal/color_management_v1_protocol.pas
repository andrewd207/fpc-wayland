...
const
  ...
  WP_COLOR_MANAGER_V1_FEATURE_SET_MASTERING_DISPLAY_PRIMARIES = 5; // parametric set_mastering_display_primaries request
  WP_COLOR_MANAGER_V1_FEATURE_EXTENDED_TARGET_VOLUME = 6; // parametric target exceeds primary color volume
  WP_COLOR_MANAGER_V1_FEATURE_WINDOWS_SCRGB = 7; // create_windows_scrgb request
  WP_COLOR_MANAGER_V1_PRIMARIES_SRGB = 1; // Color primaries for the sRGB color space as defined by the BT.709 standard
  WP_COLOR_MANAGER_V1_PRIMARIES_PAL_M = 2; // Color primaries for PAL-M as defined by the BT.470 standard
  WP_COLOR_MANAGER_V1_PRIMARIES_PAL = 3; // Color primaries for PAL as defined by the BT.601 standard
  WP_COLOR_MANAGER_V1_PRIMARIES_NTSC = 4; // Color primaries for NTSC as defined by the BT.601 standard
  WP_COLOR_MANAGER_V1_PRIMARIES_GENERIC_FILM = 5; // Generic film with colour filters using Illuminant C
  WP_COLOR_MANAGER_V1_PRIMARIES_BT2020 = 6; // Color primaries as defined by the BT.2020 and BT.2100 standard
  WP_COLOR_MANAGER_V1_PRIMARIES_CIE1931_XYZ = 7; // Color primaries of the full CIE 1931 XYZ color space
  WP_COLOR_MANAGER_V1_PRIMARIES_DCI_P3 = 8; // Color primaries of the DCI P3 color space as defined by the SMPTE RP 431 standard
  WP_COLOR_MANAGER_V1_PRIMARIES_DISPLAY_P3 = 9; // Color primaries of Display P3 variant of the DCI-P3 color space as defined by the SMPTE EG 432 standard
  WP_COLOR_MANAGER_V1_PRIMARIES_ADOBE_RGB = 10; // Color primaries of the Adobe RGB color space as defined by the ISO 12640 standard
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_BT1886 = 1; // BT.1886 display transfer characteristic
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_GAMMA22 = 2; // Assumed display gamma 2.2 transfer function
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_GAMMA28 = 3; // Assumed display gamma 2.8 transfer function
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_ST240 = 4; // SMPTE ST 240 transfer function
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_EXT_LINEAR = 5; // extended linear transfer function
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_LOG_100 = 6; // logarithmic 100:1 transfer function
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_LOG_316 = 7; // logarithmic (100*Sqrt(10) : 1) transfer function
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_XVYCC = 8; // IEC 61966-2-4 transfer function
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_SRGB = 9; // sRGB piece-wise transfer function
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_EXT_SRGB = 10; // Extended sRGB piece-wise transfer function
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_ST2084_PQ = 11; // perceptual quantizer transfer function
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_ST428 = 12; // SMPTE ST 428 transfer function
  WP_COLOR_MANAGER_V1_TRANSFER_FUNCTION_HLG = 13; // hybrid log-gamma transfer function
