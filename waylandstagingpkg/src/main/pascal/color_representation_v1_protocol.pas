...
const
  ...
  WP_COLOR_REPRESENTATION_SURFACE_V1_ALPHA_MODE_PREMULTIPLIED_ELECTRICAL = 0; // premultiplied alpha in electrical values
  WP_COLOR_REPRESENTATION_SURFACE_V1_ALPHA_MODE_PREMULTIPLIED_OPTICAL = 1; // premultiplied alpha in optical values
  WP_COLOR_REPRESENTATION_SURFACE_V1_ALPHA_MODE_STRAIGHT = 2; // straight alpha
  WP_COLOR_REPRESENTATION_SURFACE_V1_COEFFICIENTS_IDENTITY = 1; // The identity matrix
  WP_COLOR_REPRESENTATION_SURFACE_V1_COEFFICIENTS_BT709 = 2; // BT.709 matrix coefficients
  WP_COLOR_REPRESENTATION_SURFACE_V1_COEFFICIENTS_FCC = 3; // FCC matrix coefficients
  WP_COLOR_REPRESENTATION_SURFACE_V1_COEFFICIENTS_BT601 = 4; // BT.601-7 matrix coefficients
  WP_COLOR_REPRESENTATION_SURFACE_V1_COEFFICIENTS_SMPTE240 = 5; // SMPTE ST 240 matrix coefficients
  WP_COLOR_REPRESENTATION_SURFACE_V1_COEFFICIENTS_BT2020 = 6; // BT.2020 and BT.2100 YCbCr matrix coefficients
  WP_COLOR_REPRESENTATION_SURFACE_V1_COEFFICIENTS_BT2020_CL = 7; // BT.2020 matrix coefficients for constant luminance
  WP_COLOR_REPRESENTATION_SURFACE_V1_COEFFICIENTS_ICTCP = 8; // BT.2100 ICtCp matrix coefficients
  ...
  WP_COLOR_REPRESENTATION_SURFACE_V1_CHROMA_LOCATION_TYPE_0 = 1; // Horizontal offset of 0, vertical offset of 0.5
  WP_COLOR_REPRESENTATION_SURFACE_V1_CHROMA_LOCATION_TYPE_1 = 2; // Horizontal offset of 0.5, vertical offset of 0.5
  WP_COLOR_REPRESENTATION_SURFACE_V1_CHROMA_LOCATION_TYPE_2 = 3; // Horizontal offset of 0, vertical offset of 0
  WP_COLOR_REPRESENTATION_SURFACE_V1_CHROMA_LOCATION_TYPE_3 = 4; // Horizontal offset of 0.5, vertical offset of 0
  WP_COLOR_REPRESENTATION_SURFACE_V1_CHROMA_LOCATION_TYPE_4 = 5; // Horizontal offset of 0, vertical offset of 1
  WP_COLOR_REPRESENTATION_SURFACE_V1_CHROMA_LOCATION_TYPE_5 = 6; // Horizontal offset of 0.5, vertical offset of 1
