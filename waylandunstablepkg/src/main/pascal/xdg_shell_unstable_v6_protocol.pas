...
const
  ...
  XDG_POSITIONER_V6_CONSTRAINT_ADJUSTMENT_NONE = 0; // 
  XDG_POSITIONER_V6_CONSTRAINT_ADJUSTMENT_SLIDE_X = 1; // 
  XDG_POSITIONER_V6_CONSTRAINT_ADJUSTMENT_SLIDE_Y = 2; // 
  XDG_POSITIONER_V6_CONSTRAINT_ADJUSTMENT_FLIP_X = 4; // 
  XDG_POSITIONER_V6_CONSTRAINT_ADJUSTMENT_FLIP_Y = 8; // 
  XDG_POSITIONER_V6_CONSTRAINT_ADJUSTMENT_RESIZE_X = 16; // 
  XDG_POSITIONER_V6_CONSTRAINT_ADJUSTMENT_RESIZE_Y = 32; // 
